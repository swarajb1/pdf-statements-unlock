...
card_matrix: CardMatrix[BankCreditCards] = CardMatrix(
    {
        BankCreditCards.ICICI_BANK: StateData(
            cards=[
                CardData(
        ...
        BankCreditCards.HDFC_BANK: StateData(
            cards=[
                CardData(
        ...
        BankCreditCards.KOTAK_BANK: StateData(
            cards=[
                CardData(
        ...
        BankCreditCards.STANDARD_CHARTERED_BANK: StateData(
            cards=[
                CardData(
        ...
        BankCreditCards.FEDERAL_BANK: StateData(
            cards=[
                CardData(
                    number=settings.FEDERAL_BANK_CARD_1_NUMBER,
                    name=settings.FEDERAL_BANK_CARD_1_NAME,
                    file_name_match=["--"],
                ),
                CardData(
                    number=settings.FEDERAL_BANK_CARD_2_NUMBER,
                    name=settings.FEDERAL_BANK_CARD_2_NAME,
                    file_name_match=["--"],
                ),
            ],
            pdf_password=settings.FEDERAL_PDF_PASSWORD,
        ),
    },
)
